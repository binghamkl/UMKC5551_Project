...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="controls controls-row">
        ...
        <span class="span10">
			<h2>You got <asp:Label ID="uxCorrect" runat="server"></asp:Label> out of <asp:Label ID="uxTotal" runat="server"></asp:Label> Questions in <asp:Label ID="uxTimeSpan" runat="server"></asp:Label> seconds</h2>
        </span>
    </div>
